...
namespace MovieAdvice.Service.Services
{
    ...
    {
        void Enqueue<T>(IEnumerable<T> queueDataModels, RabbitMQSettingModel settings, string queueName) where T : class, new();
    }
    ...
    public class PublisherService : IPublisherService
    {
        ...
        public void Enqueue<T>(IEnumerable<T> queueDataModels, RabbitMQSettingModel settings, string queueName) where T : class, new()
        {
            try
            {
